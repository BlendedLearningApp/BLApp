...
class CreateQuizView extends StatefulWidget {
  ...
  const CreateQuizView({super.key, required this.course});
...
class _CreateQuizViewState extends State<CreateQuizView>
  ...
  void initState() {
    ...
    _addNewQuestion();
    print('📝 CreateQuizView initialized for course: ${widget.course.title}');
  }
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            'fill_quiz_details_and_questions'.tr,
                            style: TextStyle(
                              color: Colors.white.withValues(alpha: 0.9),
                              fontSize: 12,
                            ),
  ...
  void _createQuiz() async {
    ...
    print('🚀 Calling instructorController.createQuiz...');
    ...
    print('🔙 Closing create quiz screen...');
    Get.back();
  }
